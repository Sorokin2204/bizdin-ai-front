    ...
    <>
      <div className={clsx(styles.wrap)}>
        <div className={clsx(styles.container)}>
          <Head {...data} />
          <GameSignIn />
          <PackageList {...data} alert={'Перед заказом, пожалуйста, прочтите Инструкцию к товару (особенно если ваш заказ возвращается)'} />
          <GameInput {...data} />
          <DescBlock content={data.instruction} label={'Инструкция'} />
          <DescBlock content={data.desc} label={'Описание'} />
          <GameReviews {...data} />
        </div>
      </div>
    </>
